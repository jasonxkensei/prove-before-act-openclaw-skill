...
| Endpoint | Price |
|:---|:---|
| `POST /api/proof` | current price (see /api/pricing) |
| `POST /api/batch` | current price per file (see /api/pricing) |
...
# Body: {"x402Version":1,"accepts":[{"scheme":"exact","price":"<current price>","network":"eip155:8453","payTo":"0x..."}],...}
